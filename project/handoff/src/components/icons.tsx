...
export function HeartIcon({ size = 20, color = colors.cherry500, filled = true }: IconProps & { filled?: boolean }) {
  const path = "M12 21s-7.5-4.6-10-9.3C.5 8.5 2 5 5.5 5c2 0 3.4 1.1 4.2 2.4.8-1.3 2.2-2.4 4.2-2.4 3.5 0 5 3.5 3.5 6.7C19.5 16.4 12 21 12 21z";
  return (
...
export function StarIcon({ size = 20, color = colors.cherry500 }: IconProps) {
  return (
...
export function BowIcon({ size = 24, color = colors.pink300 }: IconProps) {
  return (
...
export function SparkleIcon({ size = 20, color = colors.babyBlue200 }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill={color}>
...
export function PawPrintIcon({ size = 20, color = colors.cherry500 }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill={color}>
...
export function ChevronLeftIcon({ size = 16, color = colors.cherry500 }: IconProps) {
  return (
...
export function SpeakerIcon({ size = 20, color = colors.cherry500, muted = false }: IconProps & { muted?: boolean }) {
  return (
...
export function StickerIcon({ type, size = 28 }: { type: "heart" | "star" | "bow" | "sparkle" } & IconProps) {
  switch (type) {
    ...
    case "bow": return <BowIcon size={size} />;
