...
export function PenguinWidget() {
  ...
  return (
    <>
      ...
      {/* Draggable Haru assistive touch */}
      <HaruAssistiveTouch open={open} onToggle={() => setOpen((o) => !o)} />
...
// ---------- Assistive-Touch Haru Widget ----------
// (Cleaned up, no circle pulse, perfectly clipped Haru)
...
function HaruAssistiveTouch({ open, onToggle }: { open: boolean; onToggle: () => void }) {
  ...
  // ---- PEEKING state logic ----
  const peekHiddenOffset = PEEK_CROP_W - VISIBLE_AT_REST;
